...
public class TurnoManhaAdapter extends RecyclerView.Adapter<TurnoManhaAdapter.MyViewHolder>{

    private final List<TurnoProcedimentos> categoriaList;


    public TurnoManhaAdapter(List<TurnoProcedimentos> categoriaList) {
