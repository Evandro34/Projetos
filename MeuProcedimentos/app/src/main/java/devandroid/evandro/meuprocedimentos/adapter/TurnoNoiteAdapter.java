...
public class TurnoNoiteAdapter extends RecyclerView.Adapter<TurnoNoiteAdapter.MyViewHolder>{

    private final List<TurnoProcedimentos> categoriaList;


    public TurnoNoiteAdapter(List<TurnoProcedimentos> categoriaList) {
